...
namespace EntityFrameworkInASP.NET.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Đăng nhập thất bại, tài khoản không tồn tại hoặc sai tên đăng nhâp, password.");
                    return Page();
                }
            }
